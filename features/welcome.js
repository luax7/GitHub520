...
exports.default = (function (instance, client) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                (_a.sent()).channels.fetch(config_json_1.GuildJoinChannel)
                    ...
                    client.on('guildMemberAdd', function (member) {
                        var embed = new builders_1.EmbedBuilder()
                            ...
                            .setDescription("Welcome to 5OPTiC. start your excperience by verify you in <#".concat(config_json_1.GuildVerifyChannel, ">. \n Thank you for beeing here. "));
                        channel.send({
                            embeds: [embed]
                        });
                        return;
